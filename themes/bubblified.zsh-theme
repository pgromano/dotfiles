...
prompt_symbol_color='230'
prompt_symbol_error_color='001'

user_color='235'
user_machine_symbol_color='235'
machine_color='235'

filepath_color='027'

git_clean_color='071'
git_unstaged_color='178'
git_staged_color='140' 
git_stashed_color='74'
git_unmerged_color='167'
git_symbols_color='235'

ssh_symbol_color='235'
ssh_bubble_color='115'
...
git_bubble () {
    ...
    if [[ -n $git_branch ]]; then
        ...
        echo -n "$(bubblify 0 "$git_info " $git_symbols_color $git_color)$(bubblify 2 " $git_symbols" $git_symbols_color $git_color) "
    fi
}
...
RPROMPT='%{$_lineup%}$(venv_bubble) $(git_bubble)$error_code_bubble%{$_linedown%}%{$reset_color%}'
